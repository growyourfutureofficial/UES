        ...
        appContainer.innerHTML = `
            <div class="screen text-center" style="display: flex; flex-direction: column; justify-content: center; min-height: 100vh; padding: 24px; overflow-y: auto;">
                ...
                <div class="login-header-premium" style="margin-bottom: 20px; margin-top: 15px;">
                    ...
                    <h1 class="premium-title">Ultimate Earning Source</h1>
    ...
    function renderRegisterScreen() {
        appContainer.innerHTML = `
            <div class="screen">
                ...
                <p class="subtitle text-left">Join UES</p>

                <!-- 🚀 IIT EXPERT ENGINE: 10% Welcome Bonus Trust Badge -->
                <div style="background: #e6f4ea; border: 1px dashed #1b6e35; border-radius: 12px; padding: 12px; margin-bottom: 20px; display: flex; align-items: center; gap: 10px; box-shadow: 0 4px 10px rgba(27, 110, 53, 0.05);">
                    <span class="material-symbols-rounded" style="color: #1b6e35; font-size: 28px;">redeem</span>
                    <p style="margin: 0; font-size: 12px; color: #137333; font-weight: 600; line-height: 1.4; text-align: left;">Register & Activate your plan to get an instant <strong style="font-weight: 900; background: #1b6e35; color: white; padding: 2px 6px; border-radius: 6px;">10% Welcome Bonus</strong> in your wallet!</p>
                </div>
    ...
    function renderDashboardScreen() {
        appContainer.innerHTML = `
            <div class="dashboard-layout" style="animation: fadeIn 0.3s ease-in-out;">
                ...
                <!-- 🚀 IIT EXPERT FIX: Fully Clickable Premium Plan Card with 10% Bonus UI -->
                <div class="plan-card cursor-pointer" onclick="navigateTo('deposit')" style="position: relative; transition: transform 0.1s; overflow: hidden;" onmousedown="this.style.transform='scale(0.98)'" onmouseup="this.style.transform='scale(1)'" onmouseleave="this.style.transform='scale(1)'">
                    
                    <!-- Premium 10% Ribbon -->
                    <div style="position: absolute; top: 0; right: 0; background: #FA4605; color: white; padding: 4px 12px; border-bottom-left-radius: 12px; font-size: 10px; font-weight: 900; letter-spacing: 0.5px; box-shadow: -2px 2px 10px rgba(250,70,5,0.2); z-index: 2;">10% CASHBACK</div>
                    
                    <h3 style="margin-top: 5px;">Choose a Plan</h3>
                    <p style="padding-right: 30px; margin-bottom: 8px;">Deposit karke account activate karein aur pages submit karein.</p>
                    
                    <!-- Trust & Bonus Highlight -->
                    <div style="display: inline-flex; align-items: center; gap: 4px; background: rgba(255,255,255,0.9); padding: 4px 8px; border-radius: 8px; font-size: 11px; font-weight: 800; color: #1b6e35; border: 1px solid #cce8d6;">
                        <span class="material-symbols-rounded" style="font-size: 14px;">redeem</span> Activate now to get 10% Mutual Bonus!
                    </div>
    ...
    if (!isStandalone) {
        ...
        installWall.innerHTML = `
            <div style="position: fixed; top:0; left:0; width: 100%; height: 100vh; background: #f8fafc; z-index: 999999; display: flex; flex-direction: column; justify-content: center; align-items: center; padding: 25px; text-align: center;">
                ...
                <div style="width: 110px; height: 110px; background: #ffffff; border-radius: 28px; margin-bottom: 25px; display: flex; justify-content: center; align-items: center; padding: 6px; animation: popIn 0.5s cubic-bezier(0.175, 0.885, 0.32, 1.275);">
        ...
        window.addEventListener('appinstalled', () => {
            ...
            showCustomAlert("App Installed Successfully! Please close this browser tab and open 'Ultimate Earning Source' App from your phone's home screen.");
        });
    }
